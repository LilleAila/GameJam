...
public class TerrainController4 : MonoBehaviour
{
    [SerializeField]
    ...
    private void Awake()
    {
        ...
        GenerateMesh4.UsePerlinNoise = usePerlinNoise;
    ...
    private GameObject CreateTile(int xIndex, int yIndex)
    {
        ...
        GenerateMesh4 gm = terrain.GetComponent<GenerateMesh4>();
        ...
        PlaceObjects4 po = gm.GetComponent<PlaceObjects4>();
